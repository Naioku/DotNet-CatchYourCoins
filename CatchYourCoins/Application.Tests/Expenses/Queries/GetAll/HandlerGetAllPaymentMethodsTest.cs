...
public class HandlerGetAllPaymentMethodsTest
    : HandlerGetAllTest<HandlerGetAllPaymentMethods, PaymentMethod, PaymentMethodDTO, QueryGetAllPaymentMethods, IRepositoryPaymentMethod, TestFactoryPaymentMethod>
{
